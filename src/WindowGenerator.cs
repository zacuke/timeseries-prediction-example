...
public class WindowGenerator
{
    ...
    public (IDatasetV2, IDatasetV2, IDatasetV2, Series, Series) GenerateDataset(DataFrame df)
    {
        var n = df.shape[0];
        ...
        return (MakeDataset(train_df), MakeDataset(val_df), MakeDataset(test_df), train_mean, train_std);
    }
